...
export const GET_TOTALPRODUCT_REQUEST = "GET_TOTALPRODUCT_REQUEST";
export const GET_TOTALPRODUCT_SUCCESS = "GET_TOTALPRODUCT_SUCCESS";
export const GET_TOTALPRODUCT_FAIL = "GET_TOTALPRODUCT_FAIL ";
