...
export const TOTAL_PURCHASE_ORDER_REQUEST = "GET_PURCHASE_ORDER_REQUEST";
export const TOTAL_PURCHASE_ORDER_SUCCESS = "GET_PURCHASE_ORDER_SUCCESS";
export const TOTAL_PURCHASE_ORDER_FAIL = "GET_PURCHASE_ORDER_FAIL";
